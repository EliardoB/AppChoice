...
class StoryBrain{
  ...
  void nextStory(int choiceNumber){
    ...
    if (choiceNumber == 1 && _storyCount == 0) {
      _storyCount = 2;
    } else if (choiceNumber == 2 && _storyCount == 0) {
      _storyCount = 1;
    } else if (choiceNumber == 1 && _storyCount == 1) {
      _storyCount = 2;
    } else if (choiceNumber == 2 && _storyCount == 1) {
      _storyCount = 3;
    } else if (choiceNumber == 1 && _storyCount == 2) {
      _storyCount = 5;
    } else if (choiceNumber == 2 && _storyCount == 2) {
      _storyCount = 4;
    }
    //TODO: Step 22 - In nextStory() if the storyNumber is equal to 3 or 4 or 5, that means it's the end of the game and it should call a method called restart() that resets the storyNumber to 0.
    else if(_storyCount == 3 || _storyCount == 4 || _storyCount == 5){
      restart();
    }
  }
  ...
  bool buttonShouldBeVisible(){
    if (_storyCount == 0 || _storyCount == 1 || _storyCount == 2) {
      return true;
    } else {
      return false;
    }
